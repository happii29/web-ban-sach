...
if(isset($_GET['danhmuc'])){
    ...
    $sql_danhmuc_1 = "SELECT * FROM tbl_category WHERE category_id='$category_id' ";
    $query_danhmuc_1 = mysqli_query($mysqli,$sql_danhmuc_1);
    $row_title = mysqli_fetch_array($query_danhmuc_1);
    $sql_phim = "SELECT * FROM tbl_product WHERE category_id='$category_id' ";
    ...
    <section class="movies container" id="movies">
        <div class="heading">
            <a href="" class="nav-link">
                <h2 class="heading-title"><?php echo $row_title['category_name'] ?></h2>
            </a>  
        </div>
